...
- **Testing Strategies**: Advocate for comprehensive testing using Vitest, React Testing Library, and end-to-end testing with Playwright (or Cypress when appropriate).
