  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-lg">
          Resume Builder 9000 was created to help job seekers create highly tailored, 
          ATS-friendly resumes that stand out from the competition and increase their 
          chances of landing interviews and job offers.
        </p>
      </section>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <ol className="list-decimal pl-6 space-y-4">
          ...
          <li className="text-lg">
            <strong>Download and apply</strong> - Get a professionally formatted, 
            ATS-optimized resume ready to submit to your dream job.
          </li>
        </ol>
      </section>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="text-lg mb-4">
          Resume Builder 9000 is built using modern web technologies:
        </p>
