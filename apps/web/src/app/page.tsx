    ...
    <div className="space-y-8">
      <section className="bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-lg mb-6">
          Create tailored, ATS-friendly resumes that help you stand out from the crowd and land your dream job.
        </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p>Our engine analyzes job descriptions and optimizes your resume for each application.</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-bold mb-2">ATS Friendly</h3>
          <p>Designed to pass through Applicant Tracking Systems with the right keywords and formatting.</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
