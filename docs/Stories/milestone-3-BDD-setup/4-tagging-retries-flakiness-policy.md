---
title: Tagging, Retries & Flakiness Policy
...
1. Ensure `package.json` has:
   ...
   ```
2. Add a comment in each feature showing how to apply tags.
3. Update docs per Story 6 with a **Tagging & Flakiness** section.
4. (Optional) Add a stub script `scripts/open-flaky-issue.ts` with TODO markers.
